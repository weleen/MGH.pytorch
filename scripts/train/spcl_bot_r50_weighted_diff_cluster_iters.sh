...
python projects/SpCL_new/train_net.py --config-file projects/SpCL_new/configs/MSMT17/BoT_R50.yml PSEUDO.MEMORY.WEIGHTED True PSEUDO.CLUSTER_EPOCH 1 OUTPUT_DIR logs/SpCL_new/BoT_R50_weighted_cluster1epoch/msmt17