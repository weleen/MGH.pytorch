'''
Author: WuYiming
Date: 2020-10-23 22:43:39
LastEditTime: 2020-10-25 15:41:06
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /fast-reid/projects/ActiveReID/model.py
'''
# encoding: utf-8
import logging
import torch
...
class ActiveBaseline(nn.Module):
    def __init__(self, cfg):
        ...
        # parameters
        self.register_parameter("active_triplet_loss_weight", nn.Parameter(torch.Tensor([0])))
        self.register_parameter("contrastive_loss_weight", nn.Parameter(torch.Tensor([1])))
